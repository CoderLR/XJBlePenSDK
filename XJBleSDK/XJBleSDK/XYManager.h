...
static NSString * const XYCentralErrorAutoConnectTimeOut = @"auto connect time out";
...
// 自动连接超时 默认30s
- (void)centralManger:(XYManager *)centralManger autoConnectTimeOut:(NSError *)error;
